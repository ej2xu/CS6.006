...
class PriorityQueue:
    ...
    def append(self, key):
        ...
        while i > 1:
            ...
            if key < self.heap[parent]:
                self.heap[parent], self.heap[i] = key, self.heap[parent]
                i = parent
            else: break
    ...
    def pop(self):
        ...
        while True:
            ...
            l_key = heap[l]
            r = l+1
            r_key = r < len(heap) and heap[r]
            if r_key and r_key < l_key:
                child_key = r_key
                child = r
            else:
                child_key = l_key
    ...
    def max_heapify(self, i):
        l = i*2
        r = l+1
        if l<=len(self.heap)-1 and self.heap[l]<self.heap[i]:
            st = l
        else:
            st = i
        if r<=len(self.heap)-1 and self.heap[r]<self.heap[st]:
            st = r
        if st != i:
